...
import org.jboss.modules.{ResourceLoader, ModuleClassLoader, Module, ModuleIdentifier}
import java.net.JarURLConnection
import net.liftweb.common.Loggable
import net.liftweb.util.HasParams
import net.liftweb.json.Printer
import net.liftweb.actor.{ILAExecute, SpecializedLiftActor}
...
//      val jars = classes.map { clazz =>
//      }

//      jars.foreach { root =>
//         ModuleRootMarker.mark(root)
//         deployment.addToAttachmentList(Attachments.RESOURCE_ROOTS, root)
//      }
   }
